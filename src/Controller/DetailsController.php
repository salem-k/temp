...
class DetailsController extends AppController
{
    ...
    public function add()
    {
        ...
        $commandes = $this->Details->Commandes->find('list', ['limit' => 200])->all();
        $articles = $this->Details->Articles->find('list', ['limit' => 200])->all();
        $this->set(compact('detail', 'commandes', 'articles'));
    }
