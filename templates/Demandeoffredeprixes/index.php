            ...
            <div class="box-body">
              <table id="example2" class="table table-bordered table-striped ">
                ...
                <tr>
                    ...
                    <th><?= $this->Paginator->sort('commandeclient') ?></th>
                    <th class="actions"><?= __('Actions') ?></th>
                </tr>
            </thead>
            <tbody>
                <?php foreach ($demandeoffredeprixes as $demandeoffredeprix): ?>
                <tr>
                    <td><?= $this->Number->format($demandeoffredeprix->id) ?></td>
                  ...
                  <td class="actions">
                    <?= $this->Html->link('<i class="fa fa-eye"></i>', ['action' => 'view', $demandeoffredeprix->id], ['class' => 'btn btn-info btn-sm', 'escape' => false]) ?>
