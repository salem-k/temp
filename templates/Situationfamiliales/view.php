...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Html->link(__('Edit Situationfamiliale'), ['action' => 'edit', $situationfamiliale->id], ['class' => 'side-nav-item']) ?>
            <?= $this->Form->postLink(__('Delete Situationfamiliale'), ['action' => 'delete', $situationfamiliale->id], ['confirm' => __('Are you sure you want to delete # {0}?', $situationfamiliale->id), 'class' => 'side-nav-item']) ?>
            <?= $this->Html->link(__('List Situationfamiliales'), ['action' => 'index'], ['class' => 'side-nav-item']) ?>
            <?= $this->Html->link(__('New Situationfamiliale'), ['action' => 'add'], ['class' => 'side-nav-item']) ?>
        </div>
    </aside>
    <div class="column-responsive column-80">
        <div class="situationfamiliales view content">
            <h3><?= h($situationfamiliale->name) ?></h3>
            <table>
                <tr>
                    <th><?= __('Name') ?></th>
