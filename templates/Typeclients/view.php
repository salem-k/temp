...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Html->link(__('Edit Typeclient'), ['action' => 'edit', $typeclient->id], ['class' => 'side-nav-item']) ?>
            <?= $this->Form->postLink(__('Delete Typeclient'), ['action' => 'delete', $typeclient->id], ['confirm' => __('Are you sure you want to delete # {0}?', $typeclient->id), 'class' => 'side-nav-item']) ?>
            <?= $this->Html->link(__('List Typeclients'), ['action' => 'index'], ['class' => 'side-nav-item']) ?>
            <?= $this->Html->link(__('New Typeclient'), ['action' => 'add'], ['class' => 'side-nav-item']) ?>
        </div>
    </aside>
    <div class="column-responsive column-80">
        <div class="typeclients view content">
            <h3><?= h($typeclient->type) ?></h3>
            <table>
                <tr>
                    <th><?= __('Type') ?></th>
                ...
                <tr>
                    <th><?= __('Grandsurface') ?></th>
                    <td><?= $typeclient->grandsurface ? __('Yes') : __('No'); ?></td>
                </tr>
            </table>
            <div class="related">
                <h4><?= __('Related Clients') ?></h4>
                <?php if (!empty($typeclient->clients)) : ?>
                <div class="table-responsive">
                    <table>
                        ...
                        <?php foreach ($typeclient->clients as $clients) : ?>
                        <tr>
                            <td><?= h($clients->id) ?></td>
            ...
            <div class="related">
                ...
                <?php if (!empty($typeclient->factureavoirs)) : ?>
                <div class="table-responsive">
                    <table>
                        <tr>
                            <th><?= __('Id') ?></th>
                        ...
                        <?php foreach ($typeclient->factureavoirs as $factureavoirs) : ?>
                        <tr>
