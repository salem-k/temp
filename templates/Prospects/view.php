...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Html->link(__('Edit Prospect'), ['action' => 'edit', $prospect->id], ['class' => 'side-nav-item']) ?>
            <?= $this->Form->postLink(__('Delete Prospect'), ['action' => 'delete', $prospect->id], ['confirm' => __('Are you sure you want to delete # {0}?', $prospect->id), 'class' => 'side-nav-item']) ?>
            <?= $this->Html->link(__('List Prospects'), ['action' => 'index'], ['class' => 'side-nav-item']) ?>
            <?= $this->Html->link(__('New Prospect'), ['action' => 'add'], ['class' => 'side-nav-item']) ?>
        </div>
    </aside>
    <div class="column-responsive column-80">
        <div class="prospects view content">
            ...
            <div class="related">
                ...
                <?php if (!empty($prospect->fournisseurs)) : ?>
                <div class="table-responsive">
                    <table>
                        ...
                        <?php foreach ($prospect->fournisseurs as $fournisseurs) : ?>
                        <tr>
