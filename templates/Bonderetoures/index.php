...
<div class="articles index content">
    ...
    <div class="box">
      <div class="box-body">
        <div class="row">
          ...
          <div class="col-xs-6">
            <?php
            echo $this->Form->input('numero', ['label' => 'Numero', 'value' => $this->request->getQuery('id'), 'class' => 'form-control']);
            ?>
          </div>
          <div class="col-xs-6">
            <?php
  ...
  <section class="content">
    <div class="bonretours index content">
          ...
          <div class="box">
            <div class="box-body">
              <table id="example2" class="table table-bordered table-striped ">
                <thead>
                <h3><?= __('Bons de retour') ?>
                  <!-- les bons fihomsh add -->
            ...
            <tbody>
                ...
                <tr>
                  ...
                  <td class="actions">
                    <?= $this->Html->link('<i class="fa fa-eye"></i>', ['action' => 'view', $bonderetoure->id], ['class' => 'btn btn-info btn-sm', 'escape' => false]) ?>
