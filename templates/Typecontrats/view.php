...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Html->link(__('Edit Typecontrat'), ['action' => 'edit', $typecontrat->id], ['class' => 'side-nav-item']) ?>
            <?= $this->Form->postLink(__('Delete Typecontrat'), ['action' => 'delete', $typecontrat->id], ['confirm' => __('Are you sure you want to delete # {0}?', $typecontrat->id), 'class' => 'side-nav-item']) ?>
            <?= $this->Html->link(__('List Typecontrats'), ['action' => 'index'], ['class' => 'side-nav-item']) ?>
            <?= $this->Html->link(__('New Typecontrat'), ['action' => 'add'], ['class' => 'side-nav-item']) ?>
        </div>
    </aside>
    <div class="column-responsive column-80">
        <div class="typecontrats view content">
            <h3><?= h($typecontrat->name) ?></h3>
            <table>
                <tr>
                    <th><?= __('Name') ?></th>
