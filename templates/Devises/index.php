          ...
          <div class="box">
            <div class="box-body">
              <table id="example2" class="table table-bordered table-striped ">
                ...
                <tr>
                    ...
                    <th><?= $this->Paginator->sort('symbole') ?></th>
            ...
            <tbody>
                ...
                <tr>
                  ...
                  <td class="actions">
                    <?= $this->Html->link('<i class="fa fa-eye"></i>', ['action' => 'view', $devise->id], ['class' => 'btn btn-info btn-sm', 'escape' => false]) ?>
                    <?= $this->Html->link('<i class="fa fa-pencil"></i>', ['action' => 'edit', $devise->id], ['class' => 'btn btn-primary btn-sm', 'escape' => false]) ?>
                    <?= $this->Form->postLink('<i class="fa fa-trash"></i>', ['action' => 'delete', $devise->id], ['confirm' => __('Are you sure you want to delete # {0}?', $devise->id), 'class' => 'btn btn-danger btn-sm', 'escape' => false]) ?>
                  </td>
                </tr>
                <?php endforeach; ?>
            </tbody>
