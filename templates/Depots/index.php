    ...
    <div class="box">
      <div class="box-body">
        <div class="row">
          ...
          <div class="col-xs-6">
            <?php
            echo $this->Form->input('Name', ['label' => 'Name', 'value' => $this->request->getQuery('Nom'), 'class' => 'form-control']);
            ?>
          </div>
          <div class="col-xs-6">
            <?php
            echo $this->Form->input('adresse', ['label' => 'Adresse', 'value' => $this->request->getQuery('Adresse'), 'class' => 'form-control']);
            ?>
          </div>
        </div>
          ...
          <div class="box">
            <div class="box-body">
              <table id="example2" class="table table-bordered table-striped ">
                ...
                <tr>
                    ...
                    <th><?= $this->Paginator->sort('point_de_vente_id') ?></th>
            ...
            <tbody>
                ...
                <tr>
                  ...
                  <td class="actions">
                    <?= $this->Html->link('<i class="fa fa-eye"></i>', ['action' => 'view', $depot->id], ['class' => 'btn btn-info btn-sm', 'escape' => false]) ?>
                  </td>
                </tr>
                <?php endforeach; ?>
            </tbody>
