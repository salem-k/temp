...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Html->link(__('Edit Tva'), ['action' => 'edit', $tva->id], ['class' => 'side-nav-item']) ?>
            <?= $this->Form->postLink(__('Delete Tva'), ['action' => 'delete', $tva->id], ['confirm' => __('Are you sure you want to delete # {0}?', $tva->id), 'class' => 'side-nav-item']) ?>
            <?= $this->Html->link(__('List Tvas'), ['action' => 'index'], ['class' => 'side-nav-item']) ?>
            <?= $this->Html->link(__('New Tva'), ['action' => 'add'], ['class' => 'side-nav-item']) ?>
        </div>
    </aside>
    <div class="column-responsive column-80">
        <div class="tvas view content">
            <h3><?= h($tva->name) ?></h3>
            <table>
                <tr>
                    <th><?= __('Name') ?></th>
            ...
            <div class="related">
                ...
                <div class="table-responsive">
                    <table>
                        ...
                        <?php foreach ($tva->articles as $articles) : ?>
                        <tr>
                            <td><?= h($articles->id) ?></td>
