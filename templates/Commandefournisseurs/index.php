    ...
    <div class="box">
      <div class="box-body">
        <div class="row">
          ...
          <div class="col-xs-6">
            <?php
            echo $this->Form->input('numero', ['label' => 'Numero', 'value' => $this->request->getQuery('nom'), 'class' => 'form-control']);
            ?>
          </div>
      ...
      <div class="box-body">
        ...
        <div class="col-xs-12">
          <div class="box">
            ...
            <tbody>
                <?php foreach ($commandefournisseurs as $commandefournisseur): ?>
                <tr>
                    <td><?= $this->Number->format($commandefournisseur->id) ?></td>
                  ...
                  <td class="actions">
                    <?= $this->Html->link('<i class="fa fa-eye"></i>', ['action' => 'view', $commandefournisseur->id], ['class' => 'btn btn-info btn-sm', 'escape' => false]) ?>
                  </td>
                </tr>
                <?php endforeach; ?>
            </tbody>
