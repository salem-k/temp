...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Html->link(__('Edit Typeentite'), ['action' => 'edit', $typeentite->id], ['class' => 'side-nav-item']) ?>
            <?= $this->Form->postLink(__('Delete Typeentite'), ['action' => 'delete', $typeentite->id], ['confirm' => __('Are you sure you want to delete # {0}?', $typeentite->id), 'class' => 'side-nav-item']) ?>
            <?= $this->Html->link(__('List Typeentites'), ['action' => 'index'], ['class' => 'side-nav-item']) ?>
            <?= $this->Html->link(__('New Typeentite'), ['action' => 'add'], ['class' => 'side-nav-item']) ?>
        </div>
    </aside>
    <div class="column-responsive column-80">
        <div class="typeentites view content">
            <h3><?= h($typeentite->name) ?></h3>
            <table>
                <tr>
                    <th><?= __('Name') ?></th>
            ...
            <div class="related">
                ...
                <?php if (!empty($typeentite->fournisseurs)) : ?>
                <div class="table-responsive">
                    <table>
                        ...
                        <?php foreach ($typeentite->fournisseurs as $fournisseurs) : ?>
                        <tr>
