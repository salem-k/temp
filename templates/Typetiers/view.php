...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Html->link(__('Edit Typetier'), ['action' => 'edit', $typetier->id], ['class' => 'side-nav-item']) ?>
            <?= $this->Form->postLink(__('Delete Typetier'), ['action' => 'delete', $typetier->id], ['confirm' => __('Are you sure you want to delete # {0}?', $typetier->id), 'class' => 'side-nav-item']) ?>
            <?= $this->Html->link(__('List Typetiers'), ['action' => 'index'], ['class' => 'side-nav-item']) ?>
            <?= $this->Html->link(__('New Typetier'), ['action' => 'add'], ['class' => 'side-nav-item']) ?>
        </div>
    </aside>
    <div class="column-responsive column-80">
        <div class="typetiers view content">
            <h3><?= h($typetier->name) ?></h3>
            <table>
                <tr>
                    <th><?= __('Name') ?></th>
                    <td><?= h($typetier->name) ?></td>
                </tr>
                <tr>
                    <th><?= __('Id') ?></th>
                    <td><?= $this->Number->format($typetier->id) ?></td>
                </tr>
            </table>
            <div class="related">
                <h4><?= __('Related Fournisseurs') ?></h4>
                <?php if (!empty($typetier->fournisseurs)) : ?>
                <div class="table-responsive">
                    <table>
                        ...
                        <?php foreach ($typetier->fournisseurs as $fournisseurs) : ?>
                        <tr>
