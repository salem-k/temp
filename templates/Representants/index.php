          ...
          <div class="box">
            ...
            <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <?php
                    if ($representant->has('personnel')) {
                      $nom = $representant->personnel->nom;
                      echo $this->Html->link($nom, ['controller' => 'Personnels', 'action' => 'view', $representant->personnel->id]);
                    }
                    ?>
                  </td>
                  ...
                  <td class="actions">
                    <?= $this->Html->link('<i class="fa fa-eye"></i>', ['action' => 'view', $representant->id], ['class' => 'btn btn-info btn-sm', 'escape' => false]) ?>
                    <?= $this->Html->link('<i class="fa fa-pencil"></i>', ['action' => 'edit', $representant->id], ['class' => 'btn btn-primary btn-sm', 'escape' => false]) ?>
                    <?= $this->Form->postLink('<i class="fa fa-trash"></i>', ['action' => 'delete', $representant->id], ['confirm' => __('Are you sure you want to delete # {0}?', $representant->id), 'class' => 'btn btn-danger btn-sm', 'escape' => false]) ?>
                  </td>
                </tr>
                <?php endforeach; ?>
            </tbody>
