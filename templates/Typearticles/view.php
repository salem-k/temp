...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Html->link(__('Edit Typearticle'), ['action' => 'edit', $typearticle->id], ['class' => 'side-nav-item']) ?>
            <?= $this->Form->postLink(__('Delete Typearticle'), ['action' => 'delete', $typearticle->id], ['confirm' => __('Are you sure you want to delete # {0}?', $typearticle->id), 'class' => 'side-nav-item']) ?>
            <?= $this->Html->link(__('List Typearticles'), ['action' => 'index'], ['class' => 'side-nav-item']) ?>
            <?= $this->Html->link(__('New Typearticle'), ['action' => 'add'], ['class' => 'side-nav-item']) ?>
        </div>
    </aside>
    <div class="column-responsive column-80">
        <div class="typearticles view content">
            <h3><?= h($typearticle->name) ?></h3>
            <table>
                <tr>
                    <th><?= __('Name') ?></th>
                    <td><?= h($typearticle->name) ?></td>
                </tr>
                <tr>
                    <th><?= __('Id') ?></th>
                    <td><?= $this->Number->format($typearticle->id) ?></td>
                </tr>
            </table>
            <div class="related">
                <h4><?= __('Related Articles') ?></h4>
                <?php if (!empty($typearticle->articles)) : ?>
                <div class="table-responsive">
                    <table>
                        ...
                        <?php foreach ($typearticle->articles as $articles) : ?>
                        <tr>
                            <td><?= h($articles->id) ?></td>
